...
SECRET_KEY = 'django-insecure-%odqp)yu94j^%#96pgvbd%6%6csct4l_i!jfj^_3a7krgo4)az'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # recommended for serving static files
    'django.contrib.sites',
    'allauth',
    'allauth.account',
    'allauth.socialaccount',
    'django_filters',
    'expenses',  # or whatever your app is called
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'expenses', 'templates', 'account'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
